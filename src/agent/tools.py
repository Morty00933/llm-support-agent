...
from typing import Protocol, Any, Optional, Callable, Iterable
...
class SearchKBTool:
    ...
    """
    name = "search_kb"
    description = "Search tenant knowledge base for most relevant chunks by semantic similarity."
        ...
        *,
        ...
        if session is None:
            if not self._session_getter:
                raise RuntimeError("SearchKBTool requires 'session' or session_getter()")
