...
"""
Клиент Zendesk Support (v2).
Аутентификация: Basic (email/token), где пароль — API token.
"""
...
class ZendeskClient:
    def __init__(self, subdomain: str, email: str, api_token: str, timeout: float = 30.0):
        """
    ...
    async def add_comment(self, ticket_id: int, body: str, public: bool = True) -> Dict[str, Any]:
        payload = {"ticket": {"comment": {"body": body, "public": public}}}
        return await self._request("PUT", f"/api/v2/tickets/{ticket_id}.json", json=payload)
